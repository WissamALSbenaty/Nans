...
class NotEmailError extends CustomError{
  NotEmailError({required String  fieldName}):
        super(errorMessage: "${fieldName.translateWord} ${"is Not a Valid Email".translateWord}", imagePath: '',
      );
}
