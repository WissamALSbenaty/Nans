...
class _EditAccountPageState extends State<EditAccountPage> {
  final List<String> titles=['Edit Profile','Change My Email','Change My Password',];
  final List<String> iconPaths=[Assets.user,Assets.phoneNumber,Assets.changePassword,];
  ...
  void initState() {
    onActionsPressed=[
      ...
      widget.createdController.changeEmail,
